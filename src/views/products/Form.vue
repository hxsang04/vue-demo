            ...
            <form @submit.prevent="save()">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        v-model="product.description" @blur="validate()"
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                if(this.validate()){
                    if(this.product.id) {
                        this.axios.put('http://localhost:8000/api/products/'+this.product.id, this.product).then(res => {
                            if(res.data.success){
                    ...
                    this.axios.post('http://localhost:8000/api/products', this.product).then(res => {
                        if(res.data.success){
                            this.$router.push({name: 'product.list'})
                            return
                        }
            ...
            getProduct(productId){
                this.axios.get('http://localhost:8000/api/products/'+productId).then(res => {
